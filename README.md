...
<p>タイトルの<font style="font-size: 130%; color:rgba(255, 223, 63, 0.8)">MeSM</font>は，下記から由来しています。</p>
<ul>
    <li><h2 style="color:rgba(255, 223, 63, 0.4)">Machine Learning Enhanced Structural Monitoring</h2></li>
    <li><h2 style="color:rgba(255, 223, 63, 0.4)">Mega Scale Monitoring</h2></li>
    <li><h2 style="color:rgba(255, 223, 63, 0.4)">Multi-scale Enhanced Structural Monitoring</h2></li>
    <li><h2 style="color:rgba(255, 223, 63, 0.4)">Metropolitan Scale Monitoring</h2></li>
</ul>
